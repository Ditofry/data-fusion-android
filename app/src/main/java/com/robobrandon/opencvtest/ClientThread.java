...
class ClientThread implements Runnable {
    ...
    public ClientThread( Mat frame, int serverPort, String serverIp){
        threadName = "Client Thread";
...
//        int size = (int) (capturedFrame.total());
        ...
        int size = (int) (capturedFrame.total() * capturedFrame.channels());

        byte[] buffer = new byte[size];
        capturedFrame.get(0, 0, buffer);
